...
/** The queuer's local IANA zone, captured at registration when no explicit `tz` is given. */
 ...
 * native IANA tz). Passing `now` collapses any backlog to a single fire (missed-run = skip).
 */
